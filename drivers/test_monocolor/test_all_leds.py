...
if __name__ == '__main__':
    ...
    pixels1 = neopixel.NeoPixel(LED_PIN, LED_COUNT, brightness=0.01, auto_write=False, pixel_order=neopixel.RGB)
    pixels2 = neopixel.NeoPixel(board.D12, 1024, brightness=0.01, auto_write=False, pixel_order=neopixel.RGB)
        ...
        while True:
            ...
            while True:
                ...
                if color == 1 :
                    ...
                    pixels1.fill(getRGBfromI(color))
                    pixels1.show()
                    pixels2.fill(getRGBfromI(color))
                    pixels2.show()
                else:
                    print('NOT DISPLAYED')
